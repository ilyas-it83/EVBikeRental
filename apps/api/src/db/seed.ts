...
async function seed() {
  ...
  console.log('  ✓ 5 stations created');
  ...
  for (const station of stationData) {
    for (let i = 0; i < 5; i++) {
      const batteryLevel = 40 + Math.floor(Math.random() * 61); // 40–100
  ...
  console.log('  ✓ 25 bikes created');

  // ─── Sample Rides (completed) ────────────────────
  const rideData = [
    {
      id: uid(),
      userId: riderId,
      bikeId: bikeRows[0].id,
      startStationId: stationData[0].id,
      endStationId: stationData[1].id,
      startTime: '2025-07-20T08:00:00Z',
      endTime: '2025-07-20T08:25:00Z',
      durationMinutes: 25,
      distanceKm: 2.1,
      cost: 5.25,
    ...
    },
    {
      id: uid(),
      userId: riderId,
      bikeId: bikeRows[5].id,
      startStationId: stationData[1].id,
      endStationId: stationData[2].id,
      startTime: '2025-07-21T14:30:00Z',
      endTime: '2025-07-21T15:05:00Z',
      durationMinutes: 35,
      distanceKm: 3.4,
      cost: 7.50,
      status: 'completed' as const,
    },
    {
      id: uid(),
      userId: riderId,
      bikeId: bikeRows[10].id,
      startStationId: stationData[2].id,
      endStationId: stationData[4].id,
      startTime: '2025-07-22T10:00:00Z',
      endTime: '2025-07-22T10:50:00Z',
      durationMinutes: 50,
      distanceKm: 5.8,
      cost: 12.00,
      status: 'completed' as const,
  ...
  console.log('  ✓ 3 sample rides created');
